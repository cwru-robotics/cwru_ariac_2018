...
bool BoxInspector2::model_poses_wrt_box(osrf_gear::Shipment &shipment_status) {
...
void BoxInspector2::compute_shipment_poses_wrt_world(osrf_gear::Shipment shipment_wrt_box,
