...
const double ROBOT_MOVE_MAX_ACTION_SERVER_WAIT_TIME=30.0;  //to prevent deadlocks
...
protected:
    ...
    bool wait_for_goal(double expiration_time=ROBOT_MOVE_MAX_ACTION_SERVER_WAIT_TIME); //default wait time
