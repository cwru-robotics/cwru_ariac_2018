...
protected:
    ...
    actionlib::SimpleActionClient<robot_behavior_interface::RobotBehaviorAction> ac;
    robot_behavior_interface::RobotBehaviorGoal behaviorServerGoal_;
    int8_t errorCode_;
    bool goal_success_;
    ...
    void doneCb(const actionlib::SimpleClientGoalState& state, const robot_behavior_interface::RobotBehaviorResultConstPtr& result);
    void activeCb();
    void feedbackCb(const robot_behavior_interface::RobotBehaviorFeedbackConstPtr& feedback);
    bool wrap_up();
};
