...
#include <kuka_move_as/RobotMoveActionServer.h>
...
RobotMoveActionServer::RobotMoveActionServer(ros::NodeHandle nodeHandle, string topic) :
        ...
        robotInterface(nh), traj_ctl_ac_("/ariac/arm/follow_joint_trajectory", true) {
    isPreempt = false;
...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle nh;
    RobotMoveActionServer actionServer(nh, "robot_behavior_server");
    ros::spin();
    return 0;
}
